"""
Sistema de autenticación simplificado - Solo para desarrollo local (modular)
Usa carpetas data/ y config/ cuando estén disponibles.
"""
...
class SimpleAuthSystem:
    def __init__(self):
        ...
        # Lista de emails autorizados (básica en modo simple)
...
__all__ = [
    "SimpleAuthSystem",
    "show_simple_login",
    "check_simple_authentication",
    "show_simple_user_info",
]
