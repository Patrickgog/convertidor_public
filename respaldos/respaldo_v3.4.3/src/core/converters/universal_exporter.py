...
def export_geojson_to_all_formats(geojson_data, base_name, point_color="#ff0000", line_color="#0000ff", line_width=2, output_epsg=4326):
    """
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        try:
            ...
            if token:
                # El visor Mapbox actual tiene controles internos, pero podemos inyectar colores iniciales
                html_content = create_mapbox_html(geojson_data, title=base_name, folder_name=base_name)
            else:
